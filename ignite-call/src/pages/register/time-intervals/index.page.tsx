...
import { convertTimeStringToMinutes } from '@/src/pages/utils/convert-time-string-to-minutes'
...
const timeIntervalsFormSchema = z.object({
  intervals: z
    ...
    .refine(
      ...
      {
        message:
          'The end time should be at least 1 hour distant from the start time.',
      },
    ),
})
...
export default function TimeIntervals() {
  ...
  return (
    <>
      <NextSeo title="Select your Availability | Ignite" noindex />
      <Container>
        <Header>
          <Heading as="strong">Almost There!</Heading>
          <Text>
            {"Tell us the time you're available each day of the week"}
          </Text>
